...
3. **Structured output**: LLM должен возвращать типизированный JSON через Zod схемы

4. **Поддержка множественных ТУ**

5. **Асинхронная обработка**: долгие операции не блокируют UI
